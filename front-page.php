...
<section id="unique" class="unique-section sticky-menu-location">
  <div class="container">
    <article>
      <h1 class="section-heading">Ce qui nous rend unique!</h1>
      <p class="section-description">Nous sommes conscients que la demande de financement pour votre rénovation n’est
        pas la partie la plus excitante de votre projet.C'est pour cette raison que nous nous efforçons à rendre
        cette étape un peu plus humaine et sympathique.</p>
    </article>
    <div class="row column-section text-center">
      <div class="col-md-3">
        <div class="image-top">
          <img class="image-one" src="<?php bloginfo('template_url') ?>/img/section-1.png" alt="section-1">
          <article>
...
<section class="experience-section" id="experience">
  <div class="container">
    <h1 class="experience-heading">Vivez l'expérience Réno-Finance en 3 étapes!</h1>
